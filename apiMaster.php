<?php
header('Access-Control-Allow-Origin: http://localhost:12807');
...
} else if(isset($_GET['chart_level1'])){
    $main->join_chart_level1();
    
} else if(isset($_GET['chart_level2'])){
    $main->join_chart_level2();

} else if(isset($_GET['chart_level3'])){
    $main->join_chart_level3();
}
?>
